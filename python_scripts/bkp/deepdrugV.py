...
def voronoi_atoms(bs,bs_out=None,dpi=None,size=None):
    ...
    # color by atom types
    atom_color = {'C.3':'#006600','N.3':'#000066','O.3':'#660000','S.3':'#666600','C.ar':'#009900','N.ar':'#000099','C.2':'#00CC00','O.2':'#C00000','C.cat': '#00FF00','N.am':'#3333FF','N.2':'#3333FF','N.pl3':'#6666FF','O.co2':'#FF9999'}         
    ...
    plt.savefig(bs_out, frameon=False, pad_inches=False, dpi=int(dpi), type='png')
    plt.close()
    return None
...
def myargs():
    ...
    parser.add_argument('-size', required = False, help = 'image size, eg: 128x128')
...
if __name__ == "__main__":
    args = myargs()
    voronoi_atoms(args.mol,args.out,args.dpi,args.size)
