...
touch ${results_dir}/results_CNN_${date_str}_$1.txt

cd ${results_dir}
ipython $dir/python_scripts/${python_script} $1 "$results_dir/npy" | tee ${results_dir}/results_CNN_${date_str}_$1.txt
